\subsection{Mathematical Language}\label{sec:mathlanguage}
...
A \linkterm{technical language}{technical_language} that you need to master to be successful when moving to a new environment (e.g. \linkterm{symbolic AI}{symbolicai}).
