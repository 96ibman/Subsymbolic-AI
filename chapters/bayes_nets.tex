...
\Lemma{
Given a query $\probd{Q_1, \cdots, Q_{n_Q} \mid E_1 = e_1, \cdots, E_{n_E}=e_{n_e}}$, we can ignore and remove all hidden variables that are not ancestors of any of the $Q_1, \cdots, Q_{n_Q}$ or $E_1, \cdots, E_{n_E}$
}{}
