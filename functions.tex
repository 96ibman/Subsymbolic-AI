...
We say that a \linkterm{set}{def:set} $A$ is countably infinite, iff there is a \linkterm{bijective function}{bijective} $f: A \to \mathbb{N}$. The \linkterm{cardinality}{set_cardinality} of such set is denoted by $\aleph_0$ Examples: $\mathbb{N}, \mathbb{Z}, \cdots$
}{countably_infinite}

\definition{Uncountably Infinite}{
We say that a \linkterm{set}{def:set} $A$ is \textbf{uncountably infinite}, iff $A$ is infinite and there is \textbf{no} \linkterm{bijective function}{bijective} $f: A \to \mathbb{N}$. The \linkterm{cardinality}{set_cardinality} of the such sets is denoted by $\mathfrak{c}$ (for continuum). Examples: $\mathbb{R}, [0,1], \mathbb{C}, \mathcal{P}(\mathbb{N})$
